 ...
 * Onboarding collects profile data, auto-enrolls in Foundation School,
 * and generates track recommendations based on goals/background.
 */
import { IsNotEmpty, IsOptional, IsString } from 'class-validator';

/** DTO for POST /enrollment/onboard — finalizes onboarding and triggers Foundation School enrollment. */
